...
\begin{align} 
 \vec{A} &= \myvec{ -5\\ 4 } \\ \vec{B} &= \myvec{ 4\\ 5 }
  \\\vec{C} &= \myvec{ -1\\ 4}
 \end{align}
 \begin{figure}
\centering
...
\centering
	...
	\caption{Triangle with midpoint}
	\label{tab:midpoint}	
\end{table}
\begin{figure}
\centering
...
\centering
	...
	\caption{Triangle with orthocenter}
	\label{tab:Triangle with orthocenter}	
\end{table}
...
\centering
	...
	\caption{Triangle with incircle}
	\label{tab:incircle}	
\end{table}
%
%\item Fig. \ref{fig:tri_sss_tikz} is generated using 
...
\centering
	...
	\caption{Triangle with circumcircle}
	\label{tab:circumcircle}	
\end{table}
