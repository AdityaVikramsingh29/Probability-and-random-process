...
\textbf{Question 59}
If $\pr{A}$ = $\frac{2}{5}$,$\pr{B}$ = $\frac{3}{10}$ and $\pr{AB}$ =$ \frac{1}{5}$, then $\pr{A'|B'}$.$\pr{B'|A'}$ is equal to \\
...
\begin{align}
 \pr{A'|B'}.\pr{B'|A'}  &= \frac{\pr{A'B'}}{\pr{B'}}.\frac{\pr{A'B'}}{\pr{A'}}\\
 &= \frac{\brak{\pr{A'B'}}^{2}}{\brak{1 -\pr{B}}\brak{1 -\pr{A}}}\\
