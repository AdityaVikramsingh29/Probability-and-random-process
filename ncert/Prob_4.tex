...
\end{table}
 ...
 PMF for Z is:
 \begin{align}
\text{$P_{Z}$(k)} &= \frac{1}{13} 
\text{\hspace{8mm}k = 1, 2, 3, ..., 13}\\
%\end{align}
\text{Similarly the PMF for Y and X are:} \\
 %\begin{align}
 \text{$P_{Y}$(m)} &= \frac{1}{4}
 \text{\hspace{8mm}m = 1, 2, 3}\\
 %\end{align}
 %\begin{align}
 \text{$P_{X}$(n)}&= \frac{1}{2} 
\text{ \hspace{8mm}n = 1, 2}\\
  %\end{align}
%\begin{align}
 \text{$P_{ZY}$(1,1)} &= \text{$P_{Z}$(1)}\text{$P_{Y}$(1)}\text{\hspace{8mm} as ZY = 0} \\
