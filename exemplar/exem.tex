...
\text{CDF of binomial distribution is:}\\
p\brak{X\leq k}&=  \sum_{k=0}^{k}\myvec{n\\k}p^k\brak{1-p}^{n-k}
&\text{k} = 0,1, 2,.. 7\\
\text{Probability of Hitting the target atleast twice is} &= p\brak{X\geq 2}\\
p\brak{X\geq 2} &= 1 - p\brak{X\leq 1}\\
 &= 1 - \bigg\{ \sum_{k=0}^{1}\myvec{7\\k}\brak{\frac{1}{4}}^k\brak{\frac{3}{4}}^{7-k}\bigg\}   &\text{Using CDF}\\ 
